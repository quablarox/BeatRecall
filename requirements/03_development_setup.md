...
1. Read through requirements documentation in `/requirements`
2. Familiarize yourself with the codebase structure
3. Review user stories to understand features
4. Start with MVP Phase 1 features
5. Write tests for new code
6. Follow the development workflow
...
- Ask in Flutter community channels
